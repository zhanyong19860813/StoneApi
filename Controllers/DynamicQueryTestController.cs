...
//public class DynamicQueryTestController : ControllerBase
//{
//    private readonly SqlSugarClient _db;

//    public DynamicQueryTestController(SqlSugarClient db)
//    {
//        _db = db;
//    }
...
//        // 1️⃣ SELECT
//        string selectClause = "";// BuildSelectClause(request.QueryField);

//        // 2️⃣ WHERE（统一入口）
//        WhereNode effectiveWhere =
//            request.Where ?? request.MapSimpleWhereToWhereNode(request.SimpleWhere);

//        try
//        {
//            var built = DynamicQueryBuilder.Build(
//                request.TableName,
//                selectClause,
//                effectiveWhere,
//                request.SortBy,
...
//                request.PageSize,
//                enablePaging: true,
//                columnValidator: IsValidColumnName
//            );

//            int total = _db.Ado.GetInt(built.CountSql, built.Parameters.ToArray());
//            var data = _db.Ado.SqlQuery<dynamic>(built.DataSql, built.Parameters.ToArray());

//            return Ok(new
//            {
//                code = 0,
//                data = new { items = data, total }
//            });
//        }
//        catch (Exception ex)
//        {
...
//    /// <param name="request"></param>
//    /// <returns></returns>
//    public string GetSqlQueryWhere(DynamicQueryRequest request,ref List<SugarParameter> parameters) {
